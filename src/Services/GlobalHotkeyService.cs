...
/// Message-only over hooking the flyout's HWND because RegisterHotKey is HWND- and thread-bound;
/// the flyout's HWND lifecycle (prewarm/show/hide cycles) isn't a stable anchor.
///
/// Thread affinity:

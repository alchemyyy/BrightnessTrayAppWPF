...
///   - exactly one recognized scope installed for the profile: "BrightnessTrayAppWPF.lnk"
///   - two or more (incl. Store-detected): each gets a type suffix, e.g.
///     "BrightnessTrayAppWPF (Local).lnk" / "BrightnessTrayAppWPF (System).lnk"
...
public static class StartMenuShortcut
{
    ...
    /// "(System)" while a user without Local sees plain "BrightnessTrayAppWPF".
    /// </summary>

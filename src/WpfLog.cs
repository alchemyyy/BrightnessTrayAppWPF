...
internal static class WPFLog
{
    ...
    private const string OldName = "btawpf-old.log";
    ...
    public static void Initialize()
    {
        lock (_gate)
        {
            ...
            try
            {
                ...
                _timer = new System.Threading.Timer(OnTimerTick, null, TimeConstants.LogFlushIntervalMs, TimeConstants.LogFlushIntervalMs);
                _initialized = true;
            }
            catch
            {

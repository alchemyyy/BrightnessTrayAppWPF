...
/// by rendering the tray-icon artwork at 30% brightness across multiple resolutions
...
public static class AppIconGenerator
{
    ...
    /// <summary>
    /// Renders the tray icon at 30% brightness at each size in <see cref="IconSizes"/>
    ...
    public static void Generate(string outputPath, Color foreground)
    {
        ...
        {
            RenderTargetBitmap bitmap = TrayIconRenderer.RenderBitmap(size, 50, foreground);
